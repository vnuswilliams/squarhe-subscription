...
use LogicException;
use Squarhe\Subscription\Events\FeatureConsumed;
use Squarhe\Subscription\Events\FeatureTicketCreated;
...
trait HasSubscriptions
{
     ...
     *
     * @param Plan $plan
     * @param CarbonInterface|string|null $expiration
    ...
    public function getLastConsumption($featureName)
    {
        if (empty($feature = $this->getFeature($featureName))) {
            return null;
        }
